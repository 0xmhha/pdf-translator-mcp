"""Extended PDF page interpreter.

Adapted from scholar-translator. Overrides pdfminer's PDFPageInterpreter
to capture instruction streams, handle font mapping, and filter non-text paths.
"""
